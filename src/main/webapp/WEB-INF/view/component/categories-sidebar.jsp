<div class="card sidebar-menu mb-4">
    ...
    <div class="card-body">
        <ul class="nav nav-pills flex-column category-menu">
            <li><a data-toggle="collapse" href="#menlist" role="button" class="nav-link" aria-expanded="false"
                   aria-controls="menlist">Men <span class="badge badge-secondary">42</span></a>
                <ul class="list-unstyled collapse multi-collapse" id="menlist">
